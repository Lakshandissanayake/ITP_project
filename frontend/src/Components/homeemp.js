...
import Table from './subcomponents/tableemp';
...
export default function Home() {
    ...
    const handleClick = () => {
        navigate('/createDriveremp'); // Navigate programmatically to the create driver page
    };

    // This function will be called when the "Go to Report Page" button is clicked
    const reportHandleClick = () => {
        navigate('/reportemp'); // Navigate programmatically to the report page
    };
